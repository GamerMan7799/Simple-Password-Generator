...
#define __VERSION_HEADER__
	...
	#define DEFINED_VER_BUILDS_COUNT  2
	#define DEFINED_VER_RC_FILEVERSION 1,0,2,5
	#define DEFINED_VER_RC_FILEVERSION_STRING "1, 0, 2, 5\0"
	#define DEFINED_VER_FULLVERSION_STRING  "1.0.2.5"
